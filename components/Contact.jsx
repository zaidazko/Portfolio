...
const Contact = () => {
  ...
  const services = [
    {name: "Linkedin", image: "/assets/Icons/linkedin.png", link: "https://www.linkedin.com/in/zazkoul"},
    {name: "Github", image: "/assets/Icons/github.png", link: "https://www.github.com/zaidazko"}
  ]
    ...
    <div className="flex flex-col place-items-center gap-5">
        ...
        <div className="p-5 flex gap-5  rounded-xl w-310 h-200 justify-center ">
          <form onSubmit={submitEmail} className="flex flex-col w-[50%] h-full items-center gap-10 bg-white/10 rounded-2xl px-4 py-8">
            ...
            <img className="h-5" src="/assets/Icons/send-icon.png"></img></button>
          </form>
        </div>
    </div>
  )
